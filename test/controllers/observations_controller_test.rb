...
class ObservationsControllerTest < ActionController::TestCase
  ...
  test "should create observation" do
    assert_difference('Observation.count') do
      post :create, observation: { coral_id: @observation.coral_id, location_id: @observation.location_id, private: @observation.private, resource_id: @observation.resource_id, user_id: @observation.user_id }
    end
  ...
  test "should update observation" do
    patch :update, id: @observation, observation: { coral_id: @observation.coral_id, location_id: @observation.location_id, private: @observation.private, resource_id: @observation.resource_id, user_id: @observation.user_id }
    assert_redirected_to observation_path(assigns(:observation))
  end
