class MeasurementsController < ApplicationController
  ...
  private
    ...
    def measurement_params
      params.require(:measurement).permit(:observation_id, :user_id, :trait_id, :standard_id, :value, :value_type, :orig_value, :precision_type, :precision, :precision_upper, :replicates)
    end
end
